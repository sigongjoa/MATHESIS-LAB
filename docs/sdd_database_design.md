...
| 컬럼명          | 데이터 타입   | 제약 조건       | 설명                               |
| :-------------- | :------------ | :-------------- | :--------------------------------- |
| `node_id`       | `UUID`        | `PRIMARY KEY`   | 노드 고유 식별자                   |
| `curriculum_id` | `UUID`        | `FOREIGN KEY`   | 노드가 속한 커리큘럼 맵 ID         |
| `parent_node_id`| `UUID`        | `FOREIGN KEY`, `NULLABLE` | 부모 노드 ID (최상위 노드는 NULL)  |
...
| 컬럼명            | 데이터 타입   | 제약 조건       | 설명                               |
| :---------------- | :------------ | :-------------- | :--------------------------------- |
| `content_id`      | `UUID`        | `PRIMARY KEY`   | 노드 내용 고유 식별자              |
| `node_id`         | `UUID`        | `FOREIGN KEY`, `UNIQUE` | 내용이 연결된 노드 ID              |
...
| 컬럼명            | 데이터 타입   | 제약 조건       | 설명                               |
| :---------------- | :------------ | :-------------- | :--------------------------------- |
| `link_id`         | `UUID`        | `PRIMARY KEY`   | 링크 고유 식별자                   |
| `node_id`         | `UUID`        | `FOREIGN KEY`   | 링크가 연결된 노드 ID              |
| `zotero_item_id`  | `UUID`        | `FOREIGN KEY`, `NULLABLE` | 연결된 Zotero 문헌 ID              |
| `youtube_video_id`| `UUID`        | `FOREIGN KEY`, `NULLABLE` | 연결된 YouTube 영상 ID             |
...
| 컬럼명            | 데이터 타입   | 제약 조건       | 설명                               |
| :---------------- | :------------ | :-------------- | :--------------------------------- |
| `zotero_item_id`  | `UUID`        | `PRIMARY KEY`   | Zotero 문헌 고유 식별자 (플랫폼 내부) |
...
| 컬럼명            | 데이터 타입   | 제약 조건       | 설명                               |
| :---------------- | :------------ | :-------------- | :--------------------------------- |
| `youtube_video_id`| `UUID`        | `PRIMARY KEY`   | YouTube 영상 고유 식별자 (플랫폼 내부) |
